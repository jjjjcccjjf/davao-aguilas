...
$route['api/fixtures/league/(:num)/upcoming'] = 'api/fixtures/league/$1/upcoming';
$route['api/fixtures/league/(:num)/final'] = 'api/fixtures/league/$1/final';
$route['api/ladders/league/(:num)/standings'] = 'api/ladders/standings/$1';
$route['api/ladders/league/(:num)/home'] = 'api/ladders/home/$1';
$route['api/ladders/league/(:num)/away'] = 'api/ladders/away/$1';
